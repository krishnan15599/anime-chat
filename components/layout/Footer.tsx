                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <span className="text-2xl font-black text-[var(--foreground)]">Animora</span>
                        </div>
                        ...
                        <p className="text-xs text-[var(--text-muted)]">Copyright © 2026 Animora. All rights reserved</p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="#" className="text-xs text-[var(--text-muted)] hover:text-[var(--foreground)] transition-colors">Create a Character</Link></li>
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            ...
                            <li><Link href="#" className="text-xs text-[var(--text-muted)] hover:text-[var(--foreground)] transition-colors">Animora Blog</Link></li>
