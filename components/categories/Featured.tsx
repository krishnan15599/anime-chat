...
export default function Featured() {
    return (
        <div className="w-full overflow-x-auto no-scrollbar pb-4 snap-x snap-mandatory scroll-smooth">
            <div className="grid grid-rows-2 grid-flow-col gap-4 w-max px-1">
                {FEATURED_CHARACTERS.map((char, index) => (
                    <div key={index} className="w-[160px] sm:w-[200px] lg:w-[240px] snap-start">
